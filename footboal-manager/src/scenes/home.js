...
import { SystemPlayer532, SystemPlayer442, SystemPlayer343, SystemEnemy442, SystemTeam442, SystemTeam343, SystemTeam531 } from '../data/SystemPlayer';
...
function Home() {
       ...
       function setLocalStorage(){
            ...
            localStorage.setItem("systemTeam442", JSON.stringify(SystemTeam442));
            localStorage.setItem("systemTeam343", JSON.stringify(SystemTeam343));
            localStorage.setItem("systemTeam531", JSON.stringify(SystemTeam531));
